...
- Name: a11y.spec.js >> Accessibility — main page >> has no critical axe violations on initial load
- Location: tests/e2e/a11y.spec.js:11:5
...
+         "html": "<div id=\"blog-posts\" class=\"blog-posts-grid\" aria-label=\"Blog posts\"></div>",
+         "impact": "serious",
+         "none": Array [
+           Object {
+             "data": Object {
...
+         "failureSummary": "Fix all of the following:
+   aria-label attribute cannot be used on a div with no valid role attribute.",
+         "html": "<div id=\"activity-feed\" aria-label=\"Recent GitHub activity\"></div>",
+         "impact": "serious",
+         "none": Array [
+           Object {
+             "data": Object {
...
+             "id": "color-contrast",
+             "impact": "serious",
+             "message": "Element has insufficient color contrast of 3.29 (foreground color: #ffffff, background color: #16a34a, font size: 12.0pt (16px), font weight: normal). Expected contrast ratio of 4.5:1",
+             "relatedNodes": Array [
+               Object {
+                 "html": "<a href=\"#home\" class=\"skip-link\">Skip to main content</a>",
+                 "target": Array [
+                   ".skip-link",
+                 ],
+               },
...
+   Element has insufficient color contrast of 3.29 (foreground color: #ffffff, background color: #16a34a, font size: 12.0pt (16px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<a href=\"#home\" class=\"skip-link\">Skip to main content</a>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
...
+             "id": "color-contrast",
+             "impact": "serious",
+             "message": "Element has insufficient color contrast of 3.15 (foreground color: #16a34a, background color: #f9fafb, font size: 12.0pt (16px), font weight: normal). Expected contrast ratio of 4.5:1",
+             "relatedNodes": Array [
+               Object {
+                 "html": "<section class=\"projects animate-on-scroll\" id=\"projects\">",
+                 "target": Array [
+                   "#projects",
+                 ],
+               },
...
+         ],
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 3.15 (foreground color: #16a34a, background color: #f9fafb, font size: 12.0pt (16px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<a href=\"https://github.com/and3rn3t\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"btn btn-outline\">
...
+         "none": Array [],
+         "target": Array [
+           ".btn-outline[href$=\"and3rn3t\"][target=\"_blank\"]",
+         ],
+       },
+       Object {
+         "all": Array [],
...
+             "id": "color-contrast",
+             "impact": "serious",
+             "message": "Element has insufficient color contrast of 2.34 (foreground color: #4b5563, background color: #111827, font size: 10.5pt (14px), font weight: normal). Expected contrast ratio of 4.5:1",
+             "relatedNodes": Array [
+               Object {
...
+         ],
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 2.34 (foreground color: #4b5563, background color: #111827, font size: 10.5pt (14px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<span class=\"view-count-widget\" hidden=\"\" aria-label=\"Page views\">
+             <i class=\"fas fa-eye\" aria-hidden=\"true\"></i>
+             <span data-view-count=\"\">0</span> views
+           </span>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
